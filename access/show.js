...
if (idd == "0") {
	...
	des="炼钢党的受害者";
	dgs=3;
	info="这是一位<a style=\"color: #FFAAAA;\" target=\"_blank\" href=\"index.html?haer=19\">炼钢党</a>的受害者，因吸毒过多被<strong>L-9218-73Z</strong>同志鉴定为哈儿。[br]在ĈFLŜ私藏毒品，时常在非工作时间偷偷吸毒。[br]大喊大叫“我要炼钢”，对柜子和抽屉很感兴趣。"+flagoj;
	haerona="L-9218-73Z";//刘泽宇
}
else if (idd == "22") {
    hname="腐蚀者";
