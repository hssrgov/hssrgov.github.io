...
const hnl=["“萨尤兹”联盟","提季提孩子","哈儿之王","空洞孩子","肾先生","CXK病毒","橄榄先生","小哈儿","炸（zhá）药","已体检对象","电话者","考生","器官收集者","-000","炸（zhá）药人","自行分解者","地理老师","已扭曲矩形对象","怂亮仨","炼钢党","怂亮仨的老师","吸毒者","腐蚀者","对岸对象","拎几","舞者集团","吸烟者","革新派狭义牛马型反联通状方脑类伪弘毅主义哲学家","卫生间杀手","弹琴者","排球对象","车内异常行为对象","关门者","雄性圆周运动物体","春季积雨云对象","本源党","孙子","空中悬浮对象","守门员","门神","器官凸起对象"];
...
function runtable()
{
	var rng="<tr><th>危险哈儿号码</th><th>危险哈儿名称</th></tr>\n";
	for(var j=minhn;j<=mhn;++j)
	{
		rng+="<tr><td>"+j+"</td><td><a style=\"color: #FFFFFF;\" href=\"index.html?haer="+j+"\" target=\"_blank\">"+hnl[j]+"</a></td></tr>\n";
	}
	document.getElementById("table").innerHTML=rng;
	return;
}
function nextbutton(ifnext)
{
	if(ifnext==1)window.location.href="index.html?haer="+(Number(idd)+Number(1));
	else window.location.href="index.html?haer="+(Number(idd)-Number(1));
	return;
}